...
// fire mysql query
$result = mysqli_query($con,"SELECT website_name FROM website where user_id=$pop");


// play with return result array
while($row = mysqli_fetch_array($result,MYSQLI_ASSOC)){
  $selectBoxOption .="<option value = '".$row['website_name']."'>".$row['website_name']."</option>";
  }
...
?>  
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Delete a website</h3>
        <!-- BASIC FORM ELELEMNTS -->
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
            <label for="cars">Choose the website you wish to delete:</label>
...
function delete_records() 
{
  ...
  <input type="submit" value="Delete" onclick=delete_records()>
</form>
